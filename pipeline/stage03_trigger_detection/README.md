...
|__minima__|detects UP transitions as local minima. |`NUM_INTERPOLATION_POINTS`, `USE_QUADRATIC_INTERPOLATION`, `MIN_PEAK_DISTANCE_MAXIMA`, `MIN_PEAK_DISTANCE_MINIMA`, `MINIMA_THRESHOLD_FRACTION`, `MAXIMA_THRESHOLD_FRACTION`|
