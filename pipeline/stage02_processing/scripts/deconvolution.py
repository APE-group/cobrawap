...
if __name__ == '__main__':
    ...
    CLI.add_argument("--kernel", nargs='?', type=str,
                     help="kernel response function", default="alpha")
    CLI.add_argument("--parameter1", nargs='?', type=none_or_float,
                     help="kernel parameters", default=None)
    CLI.add_argument("--parameter2", nargs='?', type=none_or_float,
                     help="kernel parameters", default=None)
